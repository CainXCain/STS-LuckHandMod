package luckyhandmod.cards;

import basemod.abstracts.CustomCard;
import luckyhandmod.LuckyHandMod;
import luckyhandmod.util.CardInfo;
import com.megacrit.cardcrawl.cards.AbstractCard;
import com.megacrit.cardcrawl.core.CardCrawlGame;
import com.megacrit.cardcrawl.localization.CardStrings;

import static luckyhandmod.LuckyHandMod.makeID;
import static luckyhandmod.util.TextureLoader.getCardTextureString;
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    LuckyHandMod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
